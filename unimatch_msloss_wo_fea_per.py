...
def main():
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        for i, ((img_x, mask_x),
            ...
            preds_scales = model(torch.cat((img_x, img_u_s1, img_u_s2, img_u_w)))
            ...
            j = 0
            for pred_x, pred_u_s1, pred_u_s2 in zip(pred_x_scales,
                                                    pred_u_s1_scales,
                                                    pred_u_s2_scales):
            ...
            if (i % (len(trainloader_u) // 8) == 0):
                ...
                # if i > 0:
                #     break
                if cfg['epochs'] - (epoch + 1) <= 20 and i < (len(trainloader_u) - 8) and i != 0:
